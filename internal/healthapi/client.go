...
type PatchSubscriberOptions struct {
	UpdateMask string
}
...
type ExportExerciseTCXOptions struct {
	PartialData bool
}
...
func (c *Client) UpdateProfile(ctx context.Context, body any) (map[string]any, error) {
	return c.UpdateProfileWithOptions(ctx, body, UpdateOptions{})
}

func (c *Client) UpdateProfileWithOptions(ctx context.Context, body any, opts UpdateOptions) (map[string]any, error) {
	return c.patch(ctx, "/v4/"+c.User+"/profile", updateQuery(opts.UpdateMask), body)
}
...
func (c *Client) UpdateSettings(ctx context.Context, body any) (map[string]any, error) {
	return c.UpdateSettingsWithOptions(ctx, body, UpdateOptions{})
}

func (c *Client) UpdateSettingsWithOptions(ctx context.Context, body any, opts UpdateOptions) (map[string]any, error) {
	return c.patch(ctx, "/v4/"+c.User+"/settings", updateQuery(opts.UpdateMask), body)
}
...
func (c *Client) ReconcileDataPoints(ctx context.Context, dataType string, opts ReconcileOptions) (map[string]any, error) {
	...
	if opts.DataSourceFamily != "" {
		query.Set("dataSourceFamily", opts.DataSourceFamily)
	}
...
func (c *Client) ExportExerciseTCX(ctx context.Context, id string) ([]byte, error) {
	return c.ExportExerciseTCXWithOptions(ctx, id, ExportExerciseTCXOptions{})
}

func (c *Client) ExportExerciseTCXWithOptions(ctx context.Context, id string, opts ExportExerciseTCXOptions) ([]byte, error) {
	query := url.Values{}
	if opts.PartialData {
		query.Set("partialData", "true")
	}
	return c.doBytes(ctx, http.MethodGet, c.dataPointName("exercise", id)+":exportExerciseTcx", query, nil)
}

func (c *Client) ListSubscribers(ctx context.Context, project string) (map[string]any, error) {
	return c.ListSubscribersWithOptions(ctx, project, SubscriberListOptions{})
}

func (c *Client) ListSubscribersWithOptions(ctx context.Context, project string, opts SubscriberListOptions) (map[string]any, error) {
	query := url.Values{}
	if opts.PageSize > 0 {
		query.Set("pageSize", fmt.Sprint(opts.PageSize))
	}
	...
	return c.get(ctx, "/v4/"+cleanProject(project)+"/subscribers", query)
}

func (c *Client) CreateSubscriber(ctx context.Context, project string, body any) (map[string]any, error) {
	return c.CreateSubscriberWithOptions(ctx, project, body, CreateSubscriberOptions{})
}

func (c *Client) CreateSubscriberWithOptions(ctx context.Context, project string, body any, opts CreateSubscriberOptions) (map[string]any, error) {
	query := url.Values{}
	if opts.SubscriberID != "" {
		query.Set("subscriberId", opts.SubscriberID)
	}
	return c.post(ctx, "/v4/"+cleanProject(project)+"/subscribers", query, body)
}

func (c *Client) PatchSubscriber(ctx context.Context, name string, body any) (map[string]any, error) {
	return c.PatchSubscriberWithOptions(ctx, name, body, PatchSubscriberOptions{})
}

func (c *Client) PatchSubscriberWithOptions(ctx context.Context, name string, body any, opts PatchSubscriberOptions) (map[string]any, error) {
	return c.patch(ctx, "/v4/"+strings.Trim(name, "/"), updateQuery(opts.UpdateMask), body)
}

func (c *Client) DeleteSubscriber(ctx context.Context, name string) (map[string]any, error) {
	return c.DeleteSubscriberWithOptions(ctx, name, DeleteSubscriberOptions{})
}

func (c *Client) DeleteSubscriberWithOptions(ctx context.Context, name string, opts DeleteSubscriberOptions) (map[string]any, error) {
	query := url.Values{}
	if opts.Force {
		query.Set("force", "true")
	}
	return c.delete(ctx, "/v4/"+strings.Trim(name, "/"), query, nil)
}
...
func updateQuery(updateMask string) url.Values {
	query := url.Values{}
	if updateMask != "" {
