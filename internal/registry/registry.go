...
var dataTypes = []DataType{
	...
	{Name: "Food", EndpointName: "food", FilterName: "food", RecordType: "Food", Operations: ops("list", "get"), Scope: "nutrition", Source: "Google Health data types docs"},
	{Name: "Food Measurement Unit", EndpointName: "food-measurement-unit", FilterName: "food_measurement_unit", RecordType: "Food", Operations: ops("list", "get"), Scope: "nutrition", Source: "Google Health data types docs"},
	...
	{Name: "Nutrition Log", EndpointName: "nutrition-log", FilterName: "nutrition_log", RecordType: "Sample", Operations: ops("list", "get", "reconcile", "rollup", "dailyRollUp", "create", "update", "batchDelete"), Scope: "nutrition", Source: "Google Health data types docs"},
